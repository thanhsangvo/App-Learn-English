...
│   ├── SavedResultsTable.jsx # Table for stored calculations
│   ├── AffiliateBanner.jsx   # Affiliate marketing component
│   └── Header.jsx
├── utils/
...
#### [NEW] [SavedResultsTable.jsx](file:///src/components/SavedResultsTable.jsx)
- Displays a table of saved calculations with key metrics (Selling Price, Margin, Profit).
- Actions: Save, Delete, Export List.

#### [NEW] [AffiliateBanner.jsx](file:///src/components/AffiliateBanner.jsx)
- A stylish banner calling for support via affiliate links.
- Contextual link for "Packaging Tape" to be placed near packaging cost input.
