...
- [ ] 4. Logic Game Loop (Trừ năng lượng):
  - Cài cắm hàm trừ ⚡ vào `learning_controller.dart` (Flashcard / Trắc nghiệm).
  - Cài cắm vào `memory_match_controller.dart` (Lật sai thẻ).
  - Cài cắm vào `listen_find_controller.dart` (Nghe tìm hình sai).
